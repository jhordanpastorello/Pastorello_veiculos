...
export default function Estoque() {
  ...
  return (
    <main className="flex h-screen w-screen items-center justify-center bg-[url('/images/bgest.png')] bg-cover ">
      <NavBar/>
      <div className=" fixed right-0 scrollbar scrollbar-thumb-yellow-400 overflow-auto scroll-smooth accent-transparent h-screen w-5/6 pt-8 pb-8 grid 2xl:grid-cols-4 md:grid-cols-2 xl:grid-cols-3 sm:grid-cols-1 gap-12 justify-center items-center text-center">

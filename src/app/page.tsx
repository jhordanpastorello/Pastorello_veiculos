  ...
  return (
    ...
    <main className="flex h-screen w-screen items-center justify-center bg-[url('/images/bg.png')] bg-cover ">
      ...
      <div className="fixed right-0 w-5/6 h-screen flex flex-col justify-start items-end ">
        <div className=" m-8 sm:w-4/6 md:w-3/6 lg:w-2/6  sm:h-4/6 lg:h-2/6 bg-zinc-700/60 rounded-2xl flex flex-col justify-center items-center text-center text-white">
          <h1 className="font-black sm:text-xl md:text-3xl">QUERENDO TROCAR <br/> DE CARRO?</h1>
          <p className="sm:font-light md:font-semibold mt-8">
